...
func main() {
	// Вызов gin.Default() возвращает новый экземпляр Engine — основного типа данных Gin, который не только
	// играет роль маршрутизатора, но и даёт нам другой функционал. В частности, Default регистрирует
	// базовое ПО промежуточного уровня, используемое при восстановлении после сбоев и для логирования
	router := gin.Default()
